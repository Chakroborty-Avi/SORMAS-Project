...
public interface Captions {
	...
	String actionAefiAssignNewReportingIdNumber = "actionAefiAssignNewReportingIdNumber";
	String actionAefiSelectPrimarySuspectVaccination = "actionAefiSelectPrimarySuspectVaccination";
	...
	String AdverseEvents_abscess = "AdverseEvents.abscess";
	String AdverseEvents_anaphylaxis = "AdverseEvents.anaphylaxis";
	String AdverseEvents_encephalopathy = "AdverseEvents.encephalopathy";
	String AdverseEvents_feverishFeeling = "AdverseEvents.feverishFeeling";
	String AdverseEvents_otherAdverseEventDetails = "AdverseEvents.otherAdverseEventDetails";
	String AdverseEvents_seizures = "AdverseEvents.seizures";
	String AdverseEvents_seizureType = "AdverseEvents.seizureType";
	String AdverseEvents_sepsis = "AdverseEvents.sepsis";
	String AdverseEvents_severeLocalReaction = "AdverseEvents.severeLocalReaction";
	String AdverseEvents_severeLocalReactionBeyondNearestJoint = "AdverseEvents.severeLocalReactionBeyondNearestJoint";
	String AdverseEvents_severeLocalReactionMoreThanThreeDays = "AdverseEvents.severeLocalReactionMoreThanThreeDays";
	String AdverseEvents_thrombocytopenia = "AdverseEvents.thrombocytopenia";
	String AdverseEvents_toxicShockSyndrome = "AdverseEvents.toxicShockSyndrome";
	String Aefi_aefiDescription = "Aefi.aefiDescription";
	String Aefi_ageGroup = "Aefi.ageGroup";
	String Aefi_autopsyDone = "Aefi.autopsyDone";
	String Aefi_changeDate = "Aefi.changeDate";
	String Aefi_country = "Aefi.country";
	String Aefi_creationDate = "Aefi.creationDate";
	String Aefi_deathDate = "Aefi.deathDate";
	...
	String Aefi_lactating = "Aefi.lactating";
	String Aefi_nationalLevelComment = "Aefi.nationalLevelComment";
	String Aefi_onsetAgeDays = "Aefi.onsetAgeDays";
	String Aefi_onsetAgeMonths = "Aefi.onsetAgeMonths";
	String Aefi_onsetAgeYears = "Aefi.onsetAgeYears";
	String Aefi_otherDeletionReason = "Aefi.otherDeletionReason";
	String Aefi_outcome = "Aefi.outcome";
	String Aefi_pastMedicalHistory = "Aefi.pastMedicalHistory";
	String Aefi_pregnant = "Aefi.pregnant";
	String Aefi_primaryVaccineVaccinationDate = "Aefi.primaryVaccineVaccinationDate";
	String Aefi_receivedAtNationalLevelDate = "Aefi.receivedAtNationalLevelDate";
	String Aefi_reportDate = "Aefi.reportDate";
	String Aefi_reporterDepartment = "Aefi.reporterDepartment";
	String Aefi_reporterDesignation = "Aefi.reporterDesignation";
	String Aefi_reporterEmail = "Aefi.reporterEmail";
	String Aefi_reporterInstitution = "Aefi.reporterInstitution";
	String Aefi_reporterName = "Aefi.reporterName";
	String Aefi_reporterPhone = "Aefi.reporterPhone";
	String Aefi_reportingIdNumber = "Aefi.reportingIdNumber";
	String Aefi_reportingUser = "Aefi.reportingUser";
	String Aefi_responsibleCommunity = "Aefi.responsibleCommunity";
	String Aefi_responsibleDistrict = "Aefi.responsibleDistrict";
	String Aefi_responsibleRegion = "Aefi.responsibleRegion";
	String Aefi_serious = "Aefi.serious";
	String Aefi_seriousReason = "Aefi.seriousReason";
	String Aefi_seriousReasonDetails = "Aefi.seriousReasonDetails";
	String Aefi_startDateTime = "Aefi.startDateTime";
	String Aefi_todaysDate = "Aefi.todaysDate";
	String Aefi_trimester = "Aefi.trimester";
	String Aefi_uuid = "Aefi.uuid";
	String Aefi_worldwideId = "Aefi.worldwideId";
	String aefiActiveAdverseEvents = "aefiActiveAdverseEvents";
	String aefiActiveInvestigations = "aefiActiveInvestigations";
	String aefiAefiDataView = "aefiAefiDataView";
	String aefiAefiInvestigationDataView = "aefiAefiInvestigationDataView";
	String aefiAefiInvestigationList = "aefiAefiInvestigationList";
	String aefiAefiList = "aefiAefiList";
	String aefiAllActiveAndArchivedAdverseEvents = "aefiAllActiveAndArchivedAdverseEvents";
	String aefiAllActiveAndArchivedInvestigations = "aefiAllActiveAndArchivedInvestigations";
	String aefiArchivedAdverseEvents = "aefiArchivedAdverseEvents";
	String aefiArchivedInvestigations = "aefiArchivedInvestigations";
	String AefiCriteria_aefiType = "AefiCriteria.aefiType";
	String AefiCriteria_outcome = "AefiCriteria.outcome";
	String AefiCriteria_vaccineManufacturer = "AefiCriteria.vaccineManufacturer";
	String AefiCriteria_vaccineName = "AefiCriteria.vaccineName";
	String aefiDashboardAefiClassificationCoincidentalAdverseEvent = "aefiDashboardAefiClassificationCoincidentalAdverseEvent";
	String aefiDashboardAefiClassificationRelatedToVaccination = "aefiDashboardAefiClassificationRelatedToVaccination";
	String aefiDashboardAefiClassificationUndetermined = "aefiDashboardAefiClassificationUndetermined";
	String aefiDashboardAefiInvestigationDiscarded = "aefiDashboardAefiInvestigationDiscarded";
	String aefiDashboardAefiInvestigationDone = "aefiDashboardAefiInvestigationDone";
	String aefiDashboardAllAefi = "aefiDashboardAllAefi";
	String aefiDashboardAllAefiInvestigation = "aefiDashboardAllAefiInvestigation";
	String aefiDashboardNonSerious = "aefiDashboardNonSerious";
	String aefiDashboardNonSeriousAefi = "aefiDashboardNonSeriousAefi";
	String aefiDashboardSerious = "aefiDashboardSerious";
	String aefiDashboardSeriousAefi = "aefiDashboardSeriousAefi";
	String aefiDashboardShowNonSeriousAefi = "aefiDashboardShowNonSeriousAefi";
	String aefiDashboardShowSeriousAefi = "aefiDashboardShowSeriousAefi";
	String aefiDeletedAdverseEvents = "aefiDeletedAdverseEvents";
	String aefiDeletedInvestigations = "aefiDeletedInvestigations";
	String AefiExport_aefiDescription = "AefiExport.aefiDescription";
	String AefiExport_birthDate = "AefiExport.birthDate";
	String AefiExport_firstName = "AefiExport.firstName";
	String AefiExport_lastName = "AefiExport.lastName";
	String AefiExport_nationalLevelComment = "AefiExport.nationalLevelComment";
	String AefiExport_onsetAgeDays = "AefiExport.onsetAgeDays";
	String AefiExport_onsetAgeGroup = "AefiExport.onsetAgeGroup";
	String AefiExport_onsetAgeMonths = "AefiExport.onsetAgeMonths";
	String AefiExport_onsetAgeYears = "AefiExport.onsetAgeYears";
	String AefiExport_outcome = "AefiExport.outcome";
	String AefiExport_patientAddressCommunity = "AefiExport.patientAddressCommunity";
	String AefiExport_patientAddressDetails = "AefiExport.patientAddressDetails";
	String AefiExport_patientAddressDistrict = "AefiExport.patientAddressDistrict";
	String AefiExport_patientAddressRegion = "AefiExport.patientAddressRegion";
	String AefiExport_primarySuspectVaccineBatchNumber = "AefiExport.primarySuspectVaccineBatchNumber";
	String AefiExport_primarySuspectVaccineBrand = "AefiExport.primarySuspectVaccineBrand";
	String AefiExport_primarySuspectVaccineDiluentBatchNumber = "AefiExport.primarySuspectVaccineDiluentBatchNumber";
	String AefiExport_primarySuspectVaccineDose = "AefiExport.primarySuspectVaccineDose";
	String AefiExport_primarySuspectVaccineManufacturer = "AefiExport.primarySuspectVaccineManufacturer";
	String AefiExport_primarySuspectVaccineName = "AefiExport.primarySuspectVaccineName";
	String AefiExport_primarySuspectVaccineOtherName = "AefiExport.primarySuspectVaccineOtherName";
	String AefiExport_primarySuspectVaccineVaccinationDate = "AefiExport.primarySuspectVaccineVaccinationDate";
	String AefiExport_receivedAtNationalLevelDate = "AefiExport.receivedAtNationalLevelDate";
	String AefiExport_reportDate = "AefiExport.reportDate";
	String AefiExport_reportingIdNumber = "AefiExport.reportingIdNumber";
	String AefiExport_reportingOfficerAddressCountryName = "AefiExport.reportingOfficerAddressCountryName";
	String AefiExport_reportingOfficerDepartment = "AefiExport.reportingOfficerDepartment";
	String AefiExport_reportingOfficerDesignation = "AefiExport.reportingOfficerDesignation";
	String AefiExport_reportingOfficerEmail = "AefiExport.reportingOfficerEmail";
	String AefiExport_reportingOfficerFacilityCommunity = "AefiExport.reportingOfficerFacilityCommunity";
	String AefiExport_reportingOfficerFacilityDistrict = "AefiExport.reportingOfficerFacilityDistrict";
	String AefiExport_reportingOfficerFacilityName = "AefiExport.reportingOfficerFacilityName";
	String AefiExport_reportingOfficerFacilityRegion = "AefiExport.reportingOfficerFacilityRegion";
	String AefiExport_reportingOfficerName = "AefiExport.reportingOfficerName";
	String AefiExport_reportingOfficerPhoneNumber = "AefiExport.reportingOfficerPhoneNumber";
	String AefiExport_serious = "AefiExport.serious";
	String AefiExport_sex = "AefiExport.sex";
	String AefiExport_startDateTime = "AefiExport.startDateTime";
	String AefiExport_vaccinationFacilityCommunity = "AefiExport.vaccinationFacilityCommunity";
	String AefiExport_vaccinationFacilityDistrict = "AefiExport.vaccinationFacilityDistrict";
	String AefiExport_vaccinationFacilityName = "AefiExport.vaccinationFacilityName";
	String AefiExport_vaccinationFacilityRegion = "AefiExport.vaccinationFacilityRegion";
	String AefiExport_worldWideId = "AefiExport.worldWideId";
	String AefiIndex_adverseEvents = "AefiIndex.adverseEvents";
	String AefiIndex_ageAndBirthDate = "AefiIndex.ageAndBirthDate";
	String AefiIndex_disease = "AefiIndex.disease";
	String AefiIndex_district = "AefiIndex.district";
	String AefiIndex_immunizationUuid = "AefiIndex.immunizationUuid";
	String AefiIndex_outcome = "AefiIndex.outcome";
	String AefiIndex_personFirstName = "AefiIndex.personFirstName";
	String AefiIndex_personLastName = "AefiIndex.personLastName";
	String AefiIndex_personUuid = "AefiIndex.personUuid";
	String AefiIndex_primaryVaccine = "AefiIndex.primaryVaccine";
	String AefiIndex_region = "AefiIndex.region";
	String AefiIndex_reportDate = "AefiIndex.reportDate";
	String AefiIndex_serious = "AefiIndex.serious";
	String AefiIndex_sex = "AefiIndex.sex";
	String AefiIndex_startDateTime = "AefiIndex.startDateTime";
	String AefiIndex_uuid = "AefiIndex.uuid";
	String AefiIndex_vaccinationDate = "AefiIndex.vaccinationDate";
	String AefiInvestigation_adSyringesUsedForImmunization = "AefiInvestigation.adSyringesUsedForImmunization";
	String AefiInvestigation_adverseEventAfterPreviousVaccinations = "AefiInvestigation.adverseEventAfterPreviousVaccinations";
	String AefiInvestigation_adverseEventAfterPreviousVaccinationsDetails = "AefiInvestigation.adverseEventAfterPreviousVaccinationsDetails";
	String AefiInvestigation_aefiClassification = "AefiInvestigation.aefiClassification";
	...
	String AefiInvestigation_birthTerm = "AefiInvestigation.birthTerm";
	String AefiInvestigation_birthWeight = "AefiInvestigation.birthWeight";
	String AefiInvestigation_caseIsPartOfACluster = "AefiInvestigation.caseIsPartOfACluster";
	String AefiInvestigation_caseIsPartOfAClusterDetails = "AefiInvestigation.caseIsPartOfAClusterDetails";
	String AefiInvestigation_causality = "AefiInvestigation.causality";
	String AefiInvestigation_causalityDetails = "AefiInvestigation.causalityDetails";
	String AefiInvestigation_changeDate = "AefiInvestigation.changeDate";
	String AefiInvestigation_clinicalDetailsDateTime = "AefiInvestigation.clinicalDetailsDateTime";
	String AefiInvestigation_clinicalDetailsOfficerDesignation = "AefiInvestigation.clinicalDetailsOfficerDesignation";
	String AefiInvestigation_clinicalDetailsOfficerEmail = "AefiInvestigation.clinicalDetailsOfficerEmail";
	String AefiInvestigation_clinicalDetailsOfficerName = "AefiInvestigation.clinicalDetailsOfficerName";
	String AefiInvestigation_clinicalDetailsOfficerPhoneNumber = "AefiInvestigation.clinicalDetailsOfficerPhoneNumber";
	String AefiInvestigation_communityInvestigationAdditionalDetails = "AefiInvestigation.communityInvestigationAdditionalDetails";
	String AefiInvestigation_conditionedIcepackUsed = "AefiInvestigation.conditionedIcepackUsed";
	String AefiInvestigation_contraIndicationScreenedPriorToVaccination = "AefiInvestigation.contraIndicationScreenedPriorToVaccination";
	String AefiInvestigation_correctDoseOrRoute = "AefiInvestigation.correctDoseOrRoute";
	String AefiInvestigation_correctProcedureForStorageFollowed = "AefiInvestigation.correctProcedureForStorageFollowed";
	String AefiInvestigation_country = "AefiInvestigation.country";
	String AefiInvestigation_creationDate = "AefiInvestigation.creationDate";
	String AefiInvestigation_currentlyOnConcomitantMedication = "AefiInvestigation.currentlyOnConcomitantMedication";
	String AefiInvestigation_currentlyOnConcomitantMedicationDetails = "AefiInvestigation.currentlyOnConcomitantMedicationDetails";
	String AefiInvestigation_deathDateTime = "AefiInvestigation.deathDateTime";
	String AefiInvestigation_deletionReason = "AefiInvestigation.deletionReason";
	String AefiInvestigation_deliveryProcedure = "AefiInvestigation.deliveryProcedure";
	String AefiInvestigation_deliveryProcedureDetails = "AefiInvestigation.deliveryProcedureDetails";
	String AefiInvestigation_errorInVaccineHandling = "AefiInvestigation.errorInVaccineHandling";
	String AefiInvestigation_errorInVaccineHandlingDetails = "AefiInvestigation.errorInVaccineHandlingDetails";
	String AefiInvestigation_errorInVaccineReconstitution = "AefiInvestigation.errorInVaccineReconstitution";
	String AefiInvestigation_errorInVaccineReconstitutionDetails = "AefiInvestigation.errorInVaccineReconstitutionDetails";
	...
	String AefiInvestigation_investigationCompletionDate = "AefiInvestigation.investigationCompletionDate";
	String AefiInvestigation_investigationDate = "AefiInvestigation.investigationDate";
	String AefiInvestigation_investigationStage = "AefiInvestigation.investigationStage";
	String AefiInvestigation_investigationStatus = "AefiInvestigation.investigationStatus";
	String AefiInvestigation_investigationStatusDetails = "AefiInvestigation.investigationStatusDetails";
	...
	String AefiInvestigation_numberOfVialsUsedInCluster = "AefiInvestigation.numberOfVialsUsedInCluster";
	String AefiInvestigation_numberOfVialsUsedInClusterDetails = "AefiInvestigation.numberOfVialsUsedInClusterDetails";
	String AefiInvestigation_numberOfWeeksPregnant = "AefiInvestigation.numberOfWeeksPregnant";
	String AefiInvestigation_otherCaregiversNames = "AefiInvestigation.otherCaregiversNames";
	String AefiInvestigation_otherDeletionReason = "AefiInvestigation.otherDeletionReason";
	String AefiInvestigation_otherInvestigationFindings = "AefiInvestigation.otherInvestigationFindings";
	String AefiInvestigation_otherSourcesWhoProvidedInfo = "AefiInvestigation.otherSourcesWhoProvidedInfo";
	String AefiInvestigation_partiallyUsedReconstitutedVaccinesInRefrigerator = "AefiInvestigation.partiallyUsedReconstitutedVaccinesInRefrigerator";
	String AefiInvestigation_pastHistoryOfSimilarEvent = "AefiInvestigation.pastHistoryOfSimilarEvent";
	String AefiInvestigation_pastHistoryOfSimilarEventDetails = "AefiInvestigation.pastHistoryOfSimilarEventDetails";
	String AefiInvestigation_patientImmunizedPeriod = "AefiInvestigation.patientImmunizedPeriod";
	String AefiInvestigation_patientImmunizedPeriodDetails = "AefiInvestigation.patientImmunizedPeriodDetails";
	String AefiInvestigation_patientReceivedMedicalCare = "AefiInvestigation.patientReceivedMedicalCare";
	String AefiInvestigation_patientReceivedMedicalCareDetails = "AefiInvestigation.patientReceivedMedicalCareDetails";
	...
	String AefiInvestigation_reportedToHealthAuthorityDate = "AefiInvestigation.reportedToHealthAuthorityDate";
	String AefiInvestigation_reportingOfficerAddress = "AefiInvestigation.reportingOfficerAddress";
	String AefiInvestigation_reportingOfficerDepartment = "AefiInvestigation.reportingOfficerDepartment";
	String AefiInvestigation_reportingOfficerDesignation = "AefiInvestigation.reportingOfficerDesignation";
	String AefiInvestigation_reportingOfficerEmail = "AefiInvestigation.reportingOfficerEmail";
	String AefiInvestigation_reportingOfficerFacility = "AefiInvestigation.reportingOfficerFacility";
	String AefiInvestigation_reportingOfficerFacilityDetails = "AefiInvestigation.reportingOfficerFacilityDetails";
	String AefiInvestigation_reportingOfficerLandlinePhoneNumber = "AefiInvestigation.reportingOfficerLandlinePhoneNumber";
	String AefiInvestigation_reportingOfficerMobilePhoneNumber = "AefiInvestigation.reportingOfficerMobilePhoneNumber";
	String AefiInvestigation_reportingOfficerName = "AefiInvestigation.reportingOfficerName";
	String AefiInvestigation_reportingUser = "AefiInvestigation.reportingUser";
	String AefiInvestigation_responsibleCommunity = "AefiInvestigation.responsibleCommunity";
	String AefiInvestigation_responsibleDistrict = "AefiInvestigation.responsibleDistrict";
	...
	String AefiInvestigation_timeOfReconstitutionMentionedOnTheVial = "AefiInvestigation.timeOfReconstitutionMentionedOnTheVial";
	String AefiInvestigation_trainingReceivedByVaccinator = "AefiInvestigation.trainingReceivedByVaccinator";
	String AefiInvestigation_typeOfSite = "AefiInvestigation.typeOfSite";
	String AefiInvestigation_typeOfSiteDetails = "AefiInvestigation.typeOfSiteDetails";
	String AefiInvestigation_typeOfSyringesUsed = "AefiInvestigation.typeOfSyringesUsed";
	String AefiInvestigation_typeOfSyringesUsedDetails = "AefiInvestigation.typeOfSyringesUsedDetails";
	String AefiInvestigation_unusableDiluentsInStore = "AefiInvestigation.unusableDiluentsInStore";
	String AefiInvestigation_unusableVaccinesInRefrigerator = "AefiInvestigation.unusableVaccinesInRefrigerator";
	String AefiInvestigation_uuid = "AefiInvestigation.uuid";
	String AefiInvestigation_vaccinationActivity = "AefiInvestigation.vaccinationActivity";
	String AefiInvestigation_vaccinationActivityDetails = "AefiInvestigation.vaccinationActivityDetails";
	String AefiInvestigation_vaccinationFacility = "AefiInvestigation.vaccinationFacility";
	...
	String AefiInvestigation_vaccineCouldHaveBeenUnSterile = "AefiInvestigation.vaccineCouldHaveBeenUnSterile";
	String AefiInvestigation_vaccineCouldHaveBeenUnSterileDetails = "AefiInvestigation.vaccineCouldHaveBeenUnSterileDetails";
	String AefiInvestigation_vaccineGivenPeriod = "AefiInvestigation.vaccineGivenPeriod";
	String AefiInvestigation_vaccineGivenPeriodDetails = "AefiInvestigation.vaccineGivenPeriodDetails";
	String AefiInvestigation_vaccineHasQualityDefect = "AefiInvestigation.vaccineHasQualityDefect";
	String AefiInvestigation_vaccineHasQualityDefectDetails = "AefiInvestigation.vaccineHasQualityDefectDetails";
	String AefiInvestigation_vaccinePhysicalConditionAbnormal = "AefiInvestigation.vaccinePhysicalConditionAbnormal";
	String AefiInvestigation_vaccinePhysicalConditionAbnormalDetails = "AefiInvestigation.vaccinePhysicalConditionAbnormalDetails";
	String AefiInvestigation_vaccinesAndDiluentsUsedRecommendedByManufacturer = "AefiInvestigation.vaccinesAndDiluentsUsedRecommendedByManufacturer";
	String AefiInvestigation_vaccineStoragePointAdditionalDetails = "AefiInvestigation.vaccineStoragePointAdditionalDetails";
	String AefiInvestigation_vaccineStorageRefrigeratorTemperatureMonitored = "AefiInvestigation.vaccineStorageRefrigeratorTemperatureMonitored";
	String AefiInvestigation_vaccineTransportationAdditionalDetails = "AefiInvestigation.vaccineTransportationAdditionalDetails";
	String aefiInvestigationClinicalDetailsOfficer = "aefiInvestigationClinicalDetailsOfficer";
	String AefiInvestigationCriteria_aefiClassification = "AefiInvestigationCriteria.aefiClassification";
	String AefiInvestigationCriteria_statusAtAefiInvestigation = "AefiInvestigationCriteria.statusAtAefiInvestigation";
	String AefiInvestigationCriteria_vaccineManufacturer = "AefiInvestigationCriteria.vaccineManufacturer";
	String AefiInvestigationCriteria_vaccineName = "AefiInvestigationCriteria.vaccineName";
	String aefiInvestigationForAdultWomen = "aefiInvestigationForAdultWomen";
	String aefiInvestigationForInfants = "aefiInvestigationForInfants";
	String AefiInvestigationIndex_aefiClassification = "AefiInvestigationIndex.aefiClassification";
	String AefiInvestigationIndex_aefiReportUuid = "AefiInvestigationIndex.aefiReportUuid";
	String AefiInvestigationIndex_ageAndBirthDate = "AefiInvestigationIndex.ageAndBirthDate";
	String AefiInvestigationIndex_disease = "AefiInvestigationIndex.disease";
	String AefiInvestigationIndex_district = "AefiInvestigationIndex.district";
	String AefiInvestigationIndex_investigationCaseId = "AefiInvestigationIndex.investigationCaseId";
	String AefiInvestigationIndex_investigationDate = "AefiInvestigationIndex.investigationDate";
	String AefiInvestigationIndex_investigationStatus = "AefiInvestigationIndex.investigationStatus";
	String AefiInvestigationIndex_personFirstName = "AefiInvestigationIndex.personFirstName";
	String AefiInvestigationIndex_personLastName = "AefiInvestigationIndex.personLastName";
	String AefiInvestigationIndex_primaryVaccine = "AefiInvestigationIndex.primaryVaccine";
	String AefiInvestigationIndex_region = "AefiInvestigationIndex.region";
	String AefiInvestigationIndex_reportDate = "AefiInvestigationIndex.reportDate";
	String AefiInvestigationIndex_sex = "AefiInvestigationIndex.sex";
	String AefiInvestigationIndex_statusOnDateOfInvestigation = "AefiInvestigationIndex.statusOnDateOfInvestigation";
	String AefiInvestigationIndex_uuid = "AefiInvestigationIndex.uuid";
	String AefiInvestigationListEntry_aefiClassification = "AefiInvestigationListEntry.aefiClassification";
	String AefiInvestigationListEntry_investigationDate = "AefiInvestigationListEntry.investigationDate";
	String AefiInvestigationListEntry_investigationStage = "AefiInvestigationListEntry.investigationStage";
	String AefiInvestigationListEntry_statusOnDateOfInvestigation = "AefiInvestigationListEntry.statusOnDateOfInvestigation";
	String aefiInvestigationMedicalCareDetailsInstruction = "aefiInvestigationMedicalCareDetailsInstruction";
	String aefiInvestigationOfThoseAffected = "aefiInvestigationOfThoseAffected";
	String aefiInvestigationReconstitutionProcedure = "aefiInvestigationReconstitutionProcedure";
	String aefiInvestigationSourceOfInformation = "aefiInvestigationSourceOfInformation";
	String aefiNewAdverseEvent = "aefiNewAdverseEvent";
	String aefiNewAefiInvestigation = "aefiNewAefiInvestigation";
	String aefiNewAefiInvestigationStageTitle = "aefiNewAefiInvestigationStageTitle";
	String aefiVaccinationsDiluentBatchLotNumber = "aefiVaccinationsDiluentBatchLotNumber";
	String aefiVaccinationsDiluentExpiryDate = "aefiVaccinationsDiluentExpiryDate";
	String aefiVaccinationsDiluentInformation = "aefiVaccinationsDiluentInformation";
	String aefiVaccinationsDiluentTimeOfReconstitution = "aefiVaccinationsDiluentTimeOfReconstitution";
	String aefiVaccinationsPrimaryVaccine = "aefiVaccinationsPrimaryVaccine";
	String aefiVaccinationsVaccineDetails = "aefiVaccinationsVaccineDetails";
	String aefiVaccinationsVaccineInformation = "aefiVaccinationsVaccineInformation";
	...
	String Contact_prophylaxisPrescribed = "Contact.prophylaxisPrescribed";
	...
	String dashboardNumberOfAdverseEvents = "dashboardNumberOfAdverseEvents";
	...
	String DiseaseConfiguration_active = "DiseaseConfiguration.active";
	String DiseaseConfiguration_ageGroups = "DiseaseConfiguration.ageGroups";
	String DiseaseConfiguration_aggregateReportingEnabled = "DiseaseConfiguration.aggregateReportingEnabled";
	String DiseaseConfiguration_automaticSampleAssignmentThreshold = "DiseaseConfiguration.automaticSampleAssignmentThreshold";
	String DiseaseConfiguration_caseFollowUpDuration = "DiseaseConfiguration.caseFollowUpDuration";
	...
	String mainMenuAdverseEvents = "mainMenuAdverseEvents";
	...
	String personFullName = "personFullName";
	...
	String Symptoms_imi_pneumoniaClinicalOrRadiologic = "Symptoms.imi.pneumoniaClinicalOrRadiologic";
	String Symptoms_imi_shock = "Symptoms.imi.shock";
	...
	String Symptoms_ipi_pneumoniaClinicalOrRadiologic = "Symptoms.ipi.pneumoniaClinicalOrRadiologic";
	...
	String Symptoms_septicaemia = "Symptoms.septicaemia";
	...
	String titleAefiInvestigationColdChainAndTransportSubTitle = "titleAefiInvestigationColdChainAndTransportSubTitle";
	String titleAefiInvestigationColdChainAndTransportVaccineTransportation = "titleAefiInvestigationColdChainAndTransportVaccineTransportation";
	String titleAefiInvestigationCommunityInvestigation = "titleAefiInvestigationCommunityInvestigation";
	String titleAefiInvestigationCommunityInvestigationThoseAffected = "titleAefiInvestigationCommunityInvestigationThoseAffected";
	String titleAefiInvestigationFirstExaminationDetails = "titleAefiInvestigationFirstExaminationDetails";
	String titleAefiInvestigationImmunizationPractices = "titleAefiInvestigationImmunizationPractices";
	String titleAefiInvestigationImmunizationPracticesInjectionTechnique = "titleAefiInvestigationImmunizationPracticesInjectionTechnique";
	String titleAefiInvestigationImmunizationPracticesReconstitution = "titleAefiInvestigationImmunizationPracticesReconstitution";
	String titleAefiInvestigationImmunizationPracticesSubTitle = "titleAefiInvestigationImmunizationPracticesSubTitle";
	String titleAefiInvestigationImmunizationPracticesSyringesAndNeedlesUsed = "titleAefiInvestigationImmunizationPracticesSyringesAndNeedlesUsed";
	String titleAefiInvestigationInvestigationStatus = "titleAefiInvestigationInvestigationStatus";
	String titleAefiInvestigationOtherFindings = "titleAefiInvestigationOtherFindings";
	...
	String View_configuration_diseaseconfiguration_short = "View.configuration.diseaseconfiguration.short";
